...
public class GerarRelatorio {
    ...
    public static void gerarLavouraEspecifica(Lavoura lavoura){
        PreparedStatement ps;
        try {
            Connection conn = conexao.Conexao.getConexao();
            
            String sql = "SELECT * FROM \"lavoura\" WHERE \"codigo\" = " + lavoura.codigo + ";";//Código SQL que ira retornar a consulta e que vc vai passar para o relatório
